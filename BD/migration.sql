...
CREATE TABLE IF NOT EXISTS `gest_parque`.`ticket` (
  ...
  `estado` ENUM('N/Pago', 'Pago') NOT NULL DEFAULT 'N/Pago',
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `gest_parque`.`pagamento`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gest_parque`.`pagamento` ;

CREATE TABLE IF NOT EXISTS `gest_parque`.`pagamento` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_ticket` INT NOT NULL,
  `montante` DECIMAL(12,2) NOT NULL,
  `data` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_pagamento_ticket1_idx` (`id_ticket` ASC),
  CONSTRAINT `fk_pagamento_ticket1`
    FOREIGN KEY (`id_ticket`)
    REFERENCES `gest_parque`.`ticket` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gest_parque`.`ticket_promocao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gest_parque`.`ticket_promocao` ;

CREATE TABLE IF NOT EXISTS `gest_parque`.`ticket_promocao` (
  `id_ticket` INT NOT NULL,
...
INSERT INTO `gest_parque`.`perfil` (`id`, `nome`) VALUES (2, 'Operador');
