...
<div class="row">
    <?php if(isset($error) && $error==true) {?>
        <div class="col-lg-12 alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Erro</strong> Modelo não encontrado!
            <button type="button" onclick="javascript:location='./?page=admin.modelos'" class="close" aria-label="Close">
    ...
    <div class="card card-primary col-lg-12">
        <div class="card-header">
            ...
            <form action="./Controlo/modelo.php?metodo=editar&id=<?php echo $registo['id'];?>" method="POST" enctype="multipart/form-data">
            <div class="card-body">
