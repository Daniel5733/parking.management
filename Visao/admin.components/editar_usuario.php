...
<div class="row">
    <?php if(isset($error) && $error==true) {?>
        <div class="col-lg-12 alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Erro</strong> Usuario não encontrado!
            <button type="button" onclick="javascript:location='./?page=admin.usuarios'" class="close" aria-label="Close">
    ...
    <div class="card card-primary col-lg-12">
        <div class="card-header">
            ...
            <form action="./Controlo/usuario.php?metodo=editar&id=<?php echo $registo['id'];?>" method="POST" enctype="multipart/form-data">
            <div class="card-body">
            ...
            <?php } ?>
                ...
                <select required class="form-control" name="id_perfil">
                    ...
                    ?>
                    <option value="<?php echo $perfil['id']; ?>" <?php if($registo['id_perfil'] == $perfil['id']) {?>selected="true"<?php } ?>>
                ...
                <div class="form-group">
                <label>Email</label>
                <input type="email" required class="form-control" name="email" value="<?php echo $registo['email'];?>" placeholder="Introduza o Seu Email">
                </div>
                <div class="form-group">
                <label>Senha</label>
